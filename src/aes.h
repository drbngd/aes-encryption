...
private:
    ...
    static std::string IntToHex(const uint8_t& num);

    // member variables
    static std::string plaintext;
    static std::array<std::string, 2> keys;
    static std::array<std::array<uint8_t, 4>, 4> state_matrix, key_matrix;
    static constexpr std::array<std::array<uint8_t, 4>, 4> mix_column_matrix = {{
           {0x02, 0x03, 0x01, 0x01},
           {0x01, 0x02, 0x03, 0x01},
           {0x01, 0x01, 0x02, 0x03},
           {0x03, 0x01, 0x01, 0x02}
